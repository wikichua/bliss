                ...
                <x-slot name="actionsRow">
                    <x-bliss::search-modal :pageOptions="$pageOptions">
                        <x-slot name="actionButtons">
                            <a class="action-button" href="{{ route('cronjob.create') }}">Create <svg class="w-4 h-4 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></a>
                        </x-slot>
                        ...
                        <x-slot name="modalBody">
                            ...
                            <x-bliss::search-select id="status" label="Status" multiple wire:model.defer="filters.status" :options="settings('cronjob_status')" />
